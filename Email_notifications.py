...
send_mail(port, host, sender_email, sender_password, transaction_data, transaction_subject, 
                          transaction_text, transaction_html)

# sends login notification email
send_mail(port, host, sender_email, sender_password, notification_data, notification_subject, 
